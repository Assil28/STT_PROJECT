...
export class VoyageAddParMoisComponent implements OnInit {
  ...
  constructor(private datePipe:DatePipe,private router:Router,private formBuilder: FormBuilder, private voyageService: VoyageService,public dialogRef: MatDialogRef<VoyageAddParMoisComponent>,private busService:BusService) {}
  ...
  addVoyage() {
    ...
    /*   if (formattedBirthday !== null) {
      ...
      this.voyageService.createVoyagesBetweenDates(this.form.value).subscribe(
        res => {
          console.log(res);
          this.close();
        },
